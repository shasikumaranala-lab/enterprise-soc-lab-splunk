...
![Enterprise SOC Dashboard](screenshots/01-enterprise-soc-dashboard.png)
...
![Authentication Statistics](screenshots/03-authentication-statistics.png)

Displays successful and failed Windows authentication events collected from the lab environment.

---

### Security Statistics

![Security Statistics](screenshots/04-security-statistics.png)

Provides an overview of Windows security events and their distribution across monitored systems.
...
Visualizes the chronological sequence of security events to support incident investigations.
...
Custom detection rule created using Splunk Processing Language (SPL) to identify suspicious authentication activity.

---

### Active Directory Environment

![Active Directory](screenshots/08-active-directory-users.png)

Windows Server 2022 configured as the Active Directory Domain Controller for the Enterprise SOC Lab.

---

### Windows Event Viewer

![Windows Event Viewer](screenshots/09-windows-event-viewer.png)

Windows Security Event Logs generated by the operating system before being forwarded to Splunk Enterprise.

---

### Splunk Universal Forwarder Configuration

![Universal Forwarder](screenshots/10-universal-forwarder-configuration.png)

Configuration of the Splunk Universal Forwarder responsible for collecting and forwarding Windows Event Logs to Splunk Enterprise.

---

## Additional Screenshots

Additional screenshots demonstrating SPL searches, indexed events, detection alerts, and the complete monitoring workflow are available in the [`screenshots/`](screenshots/) directory.
